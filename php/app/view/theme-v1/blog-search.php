                ...
                <div class="col-lg-8 col-md-12 col-12">
                    <?php if ($posts): ?>
                        <div class="find-post-mssg">
                            <strong>ARAMA SONUÇU: <?= get('q'); ?></strong>
                            ile ilgili <strong><?= $totalRecord; ?></strong> adet paylaşım bulundu :)
                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="pagination-wrapper pagination-wrapper-2">
                                            <ul>
                                                <li class="float-left">
                                                    <a class="next"
                                                       href="<?= siteUrl('blog/search?q=' . get('q') . '&' . $pageParam . '=' . $db->prevPage()); ?>">
                                                ...
                                                <li class="float-right">
                                                    <a class="next"
                                                       href="<?= siteUrl('blog/search?q=' . get('q') . '&' . $pageParam . '=' . $db->nextPage()); ?>">
                    ...
                    <?php else: ?>
                        <div class="alert alert-warning">
                            <strong>UYARI: <?= get('q'); ?></strong>
                            ile ilgili herhangi bir paylaşım bulunamadı, lütfen daha sonra tekrar kontrol ediniz!
                        </div>
                    <?php endif; ?>
                </div>
