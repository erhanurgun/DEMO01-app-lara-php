                ...
                <div class="col-lg-8 col-md-12 col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="pagination-wrapper pagination-wrapper-2">
                                            <ul>
                                                <li class="float-left">
                                                    <a class="next"
                                                       href="<?= siteUrl('blog/tag/' . $tag['tag_url'] . '?' . $pageParam . '=' . $db->prevPage()); ?>">
                                                        <i class="fa fa-long-arrow-left"></i>
                                                        <b class="for-desktop">Önceki</b>
                                                    </a>
                                                </li>
                                                <!-- loop area start -->
                                                <?= $db->showPagination(siteUrl('blog/tag/' . $tag['tag_url'] . '?' . $pageParam . '=[page]')); ?>
                                                <!-- loop area end -->
                                                <li class="float-right">
                                                    <a class="next"
                                                       href="<?= siteUrl('blog/tag/' . $tag['tag_url'] . '?' . $pageParam . '=' . $db->nextPage()); ?>">
                    ...
                    <?php else: ?>
                        <div class="alert alert-warning">
                            <strong>UYARI: <?= $tag['tag_name']; ?></strong>
